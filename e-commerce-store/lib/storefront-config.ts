...
// import working.
export { getSizeCheckoutMode, getCategoryCheckoutMode, hasMixedCheckoutModes, sizeCheckoutModes, resolveSizeLimits, resolveCategoryLimits, normalizeInventorySyncSlug, resolveInventorySyncSlug, sharedInventoryField } from './checkout-mode';
