 ...
 */
const MERCHANT_ALLOWED_EXACT = new Set(['/', '/catalog', '/api/store', '/api/catalog/status', '/api/checkout', '/api/checkout/cart', '/api/checkout/confirm-setup', '/api/checkout/auto-draw']);
