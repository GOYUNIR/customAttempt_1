...
import { createRedisClient, archiveProductToCatalog, unarchiveProductFromCatalog } from '@/lib/server-config';
...
export async function POST(request: Request) {
  try {
    ...
    const { action, productId, name, image, description, availableFrom, verificationKey } = body;
    ...
    // 'archive' or 'update-dates' both write/overwrite the same record.
