        ...
        <section style={{ padding: '24px', borderRadius: '24px', background: '#111', border: '1px solid #27272a' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <label style={{ fontSize: '11px', color: '#a1a1aa', textTransform: 'uppercase' }}>
          ...
          <div style={{ borderTop: '1px solid #27272a', paddingTop: '16px' }}>
            <h3 style={{ margin: '0 0 4px 0', fontSize: '14px', textTransform: 'uppercase', color: '#f59e0b' }}>
              🗂️ Catalog Archive
            </h3>
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ fontWeight: '600', fontSize: '13px' }}>
                        {product.name}{' '}
                        {isArchived && <span style={{ color: '#94a3b8', fontSize: '10px' }}>(ARCHIVED)</span>}
                      </div>
                      {isArchived ? (
                        <button
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div
                        style={{
                          color: subCount >= maxLimit ? '#f87171' : '#34d399',
        ...
        <section style={{ padding: '24px', borderRadius: '24px', background: '#111', border: '1px solid #27272a' }}>
          ...
          >
            <div style={{ background: '#09090b', padding: '14px', borderRadius: '14px', border: '1px solid #1f1f23' }}>
              <span style={{ color: '#edb210', fontSize: '11px', display: 'block', marginBottom: '4px', fontWeight: 'bold' }}>
                👥 CURRENTLY ONLINE
              </span>
              <strong style={{ color: '#fff', fontSize: '18px', fontFamily: 'monospace' }}>
                {status?.liveActiveUsersOnline ?? 1}
              </strong>
            </div>
            <div style={{ background: '#09090b', padding: '14px', borderRadius: '14px', border: '1px solid #1f1f23' }}>
              <span style={{ color: '#888', fontSize: '11px', display: 'block', marginBottom: '4px', fontWeight: 'bold' }}>
                STRIPE
              </span>
          ...
          <details style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', maxHeight: '200px', overflowY: 'auto', marginTop: '10px' }}>
              {(status?.onlineVisitors || []).length === 0 && (
                <p style={{ fontSize: '12px', color: '#555' }}>No active visitors right now.</p>
              )}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                        <span style={{ color: '#fff', fontSize: '13px', fontWeight: '500' }}>
                          {String(entry?.email || 'Anonymous Client')}
                        </span>
                        <span style={{ color: '#555', fontSize: '11px', fontFamily: 'monospace' }}>
                          Hash: {String(entry?.id || 'n/a')}
                        </span>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <span style={{ color: '#34d399', fontSize: '12px', fontWeight: 'bold', display: 'block' }}>
                          {String(entry?.variant || 'Elysian Variant')}
                        </span>
                        <span style={{ color: '#888', fontSize: '11px' }}>
                          {String(entry?.size || '50ml')} — {logTime}
                        </span>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ color: '#aaa' }}>
                          {revealAddresses
                            ? String(entry?.shippingAddress || 'Form Input Field Entry')
                            : '•••• •••• (hidden)'}
                        </span>
                      </span>
                      <span
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  border: '1px solid #27272a',
                  background: currentPage === 1 ? 'transparent' : '#1c1c1e',
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  border: '1px solid #27272a',
                  background: currentPage === totalPages ? 'transparent' : '#1c1c1e',
