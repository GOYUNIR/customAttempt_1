...
test('LEAK GUARD: a merchant address serves only tenant-aware paths', () => {
  for (const p of ['/', '/catalog', '/catalog/', '/api/store', '/api/catalog/status', '/api/checkout', '/api/checkout/cart', '/roccstar', '/some-product']) {
  ...
  for (const p of ['/api/store/config', '/api/config/public', '/api/promo/validate', '/api/auth/me', '/api/ai/hero-animation',
    '/api/analytics/heartbeat', '/api/checkout/direct', '/api/checkout/confirm-setup', '/api/account/lookup', '/story', '/terms', '/account', '/admin', '/og', '/icon',
