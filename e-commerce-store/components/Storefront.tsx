    ...
    <div ref={containerRef} style={{ background: configPalette.primaryBackground, color: configPalette.textMain, position: 'relative', width: '100%', minHeight: '450vh' }}>
      <header
        style={{
          ...
          background: 'rgba(10,10,10,0.88)', backdropFilter: 'blur(15px)', display: 'flex', alignItems: 'center',
          justifyContent: 'space-between', padding: '0 16px', zIndex: 100, boxSizing: 'border-box',
        }}
      >
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%' }}>
        ...
        <section style={{ minHeight: '130vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '100px 15px 40px', background: configPalette.primaryBackground, position: 'relative', zIndex: 10, boxSizing: 'border-box' }}>
          <div style={{ width: '100%', maxWidth: 380, display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 80 }}>
            <div style={{ background: '#141416', padding: 14, borderRadius: 14, border: `1px solid ${configPalette.cardBorder}`, textAlign: 'center' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <form onSubmit={submitRaffleEntry} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <input required type="text" value={form.shippingAddress} onChange={(e) => setForm((prev) => ({ ...prev, shippingAddress: e.target.value }))}
                    placeholder={GOYUNIR_STORE_SUITE.raffleRegistrationForm.addressPlaceholder} autoComplete="street-address"
                    style={{ width: '100%', padding: 14, borderRadius: 12, background: 'rgba(22,22,26,0.7)', border: `1px solid ${configPalette.cardBorder}`, color: configPalette.textMain, fontSize: 13, boxSizing: 'border-box' }} />
